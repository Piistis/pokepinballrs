...
void LoadPortraitGraphics(s16 displayMode, s16 picIx)
{
    ...
    case PORTRAIT_STATE_POKEMON_DISPLAY:
        ...
        DmaCopy16(
            3,
            gMonPortraitGroupGfx[portraitGfxIndex / 15] + (portraitGfxIndex % 15) * 0x300,
            (void *)0x06010CA0 + picIx * 24,
            0x300);
        DmaCopy16(
            3,
            gMonPortraitGroupPals[portraitGfxIndex / 15][portraitGfxIndex % 15],
            OBJ_PLTT_SLOT(13),
            PLTT_SLOT_SIZE);
        DmaCopy16(3, gMonPortraitGroupPals[0][15], OBJ_PLTT_SLOT(15), PLTT_SLOT_SIZE);
        break;
    case PORTRAIT_STATE_EVO_PREVIEW:
        ...
        if (gCurrentPinballGame->evoChainPosition > 0)
        {
            ...
            if (pokedexFlag == SPECIES_UNSEEN)
            {
                ...
                DmaCopy16(3, gPokedexSprites_Pals, OBJ_PLTT_SLOT(13), PLTT_SLOT_SIZE);
            }
        ...
        {
            DmaCopy16(3, gPokedexSprites_Gfx + 0x5C00, (void *)0x06010CA0 + picIx * 0x18, 0x300);
        }
        else
        {
            DmaCopy16(
